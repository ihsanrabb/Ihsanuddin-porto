      ...
      <Container maxWidth="md" className="about-container">
        <Grid container spacing={2}>
          ...
          <Grid item xs={12} md={6}>
            <img src="/ihsan-avatar.jpg" alt="Avatar" className="about-img" />
          </Grid>
          <Grid item xs={12} md={6}>
            ...
            <Button variant="outlined" color="secondary" size="medium" href="https://firebasestorage.googleapis.com/v0/b/sadari-covid.appspot.com/o/news%2F1601438229081CV%20Ihsanuddin%20Rabbani.pdf?alt=media&token=8577b701-62d1-410e-82e8-ccadb24d9513" target="_blank">
              View resume
            </Button>
          </Grid>
        </Grid>
